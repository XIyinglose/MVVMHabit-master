...
public class NetWorkViewModel extends BaseViewModel {
 ...
 //   public ItemBinding<NetWorkItemViewModel> itemBinding = ItemBinding.of(BR.viewModel, R.layout.item_network);
    //RecyclerView多布局写法
    public ItemBinding<NetWorkItemViewModel> itemBinding = ItemBinding.of(new OnItemBind<NetWorkItemViewModel>() {
        @Override
        public void onItemBind(ItemBinding itemBinding, int position, NetWorkItemViewModel item) {
            if (position == 0) {
                //设置头布局
